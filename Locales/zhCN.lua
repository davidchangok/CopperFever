...
-- ====================================================================
L["MAP_LIST"] = "地图列表"
L["CURRENCY_SELECTION"] = "货币选择"
L["CONFIG_DATA_TITLE"] = "地图-货币关联"
L["CONFIG_MAP_CURRENCIES"] = "地图货币"
L["CONFIG_MAP_REPUTATIONS"] = "地图声望"
...
-- ====================================================================
L["MSG_MAP_CHANGED"] = "进入：%s"
L["INFO_FIRST_RUN"] = "欢迎使用铜币狂热！输入 /cf 打开设置。"
L["MSG_DATA_IMPORTING"] = "正在导入数据..."
L["MSG_DATA_IMPORTED"] = "数据导入成功！"
